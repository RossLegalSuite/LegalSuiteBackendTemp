(self["webpackChunk"] = self["webpackChunk"] || []).push([["view-pages-extra-screens-ExtraScreenTemplatesForm-vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/extra-screens/ExtraScreenTemplatesForm.vue?vue&type=script&lang=js&":
/*!****************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/extra-screens/ExtraScreenTemplatesForm.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _pages_merge_template__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @pages/merge-template */ "./resources/js/pages/merge-template.js");
/* harmony import */ var _components_modals_modal_template__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @components/modals/modal-template */ "./resources/js/components/modals/modal-template.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  mixins: [_pages_merge_template__WEBPACK_IMPORTED_MODULE_3__["default"], _pages_form_template__WEBPACK_IMPORTED_MODULE_2__["default"], _components_modals_modal_template__WEBPACK_IMPORTED_MODULE_4__["default"]],
  components: {
  ...
  methods: {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (_this3.$parent.record.location === 'Matter' || _this3.$parent.record.location === 'Document Set' || _this3.$parent.record.location === 'Matter Type') {
                  _this3.dataSource = 'Matters';

                  _this3.selectMatter.selectMatter(_this3);
                } else if (_this3.$parent.record.location === 'Party' || _this3.$parent.record.location === 'Party Entity' || _this3.$parent.record.location === 'Party Type') {
                  _this3.dataSource = 'Parties';

                  _this3.selectParty.selectParty(_this3);
                } else if (_this3.$parent.record.location === 'Party Role') {
                  _this3.dataSource = 'Party Roles';

                  _this3.selectMatterParty.selectMatterParty(_this3);
                }
    ...
    okClicked: function okClicked() {
      ...
      axios.post('/document_templates/store', _objectSpread(_objectSpread({}, this.record), source)).then(function (response) {
...
/***/ "./resources/js/pages/merge-template.js":
/*!**********************************************!*\
  !*** ./resources/js/pages/merge-template.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Vue.extend({
  ...
  watch: {
    ...
    pdfFile: function pdfFile(newValue) {
      var _this = this;

      if (newValue) {
        setTimeout(function () {
          $('#' + _this.id + '-pdf-iframe')[0].src = newValue;
        });
      }
    }
  },
  methods: {
    employeeSelected: function employeeSelected(id, name) {
      var _this2 = this;
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                root.$snotify.simple(_this2.record.title + ' with ' + name, 'Assembling', {
                  timeout: 0,
                  icon: 'img/cogs.gif'
                });
                _context.next = 3;
                return root.documentAssembly.createEmployeeDocument(id).then(function (convertResponse) {
                  _this2.showMergedDocument(convertResponse);
                });
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                root.$snotify.simple(_this3.record.title + ' with ' + selectedRecord.fileref, 'Assembling', {
                  timeout: 0,
                  icon: 'img/cogs.gif'
                });
                _context2.next = 3;
                return root.documentAssembly.createMatterDocument(id).then(function (convertResponse) {
                  _this3.showMergedDocument(convertResponse);
                });
    ...
    // Override default one set in form-template.js
    customPartySelected: function customPartySelected(selectedRecord) {
      var _this4 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                root.$snotify.simple(_this4.record.title + ' with ' + selectedRecord.name, 'Assembling', {
                  timeout: 0,
                  icon: 'img/cogs.gif'
                });
                _context3.next = 3;
                return root.documentAssembly.createPartyDocument(id).then(function (convertResponse) {
                  _this4.showMergedDocument(convertResponse);
                });
    ...
    matterPartySelected: function matterPartySelected(selectedRecord) {
      var _this5 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                root.$snotify.simple(_this5.record.title + ' with ' + selectedRecord.name, 'Assembling', {
                  timeout: 0,
                  icon: 'img/cogs.gif'
                });
                _context4.next = 3;
                return root.documentAssembly.createMatterPartyDocument(selectedRecord.id).then(function (convertResponse) {
                  _this5.showMergedDocument(convertResponse);
                });
    ...
    showMergedDocument: function showMergedDocument(convertResponse) {
      var pdfDocument = {
    ...
    checkDocumentSource: function checkDocumentSource(docxFile) {
      var _this6 = this;

      //https://docxtemplater.readthedocs.io/en/latest/faq.html#get-list-of-placeholders
      root.documentAssembly.loadFile(docxFile, function (error, content) {
        if (error) {
          _this6.source = 'General';
          throw error; //Ajax error is handled in window.onerror in custom.js
        } else {
          var zip = new PizZip(content); //console.log('zip.files[word/document.xml]',zip.files['word/document.xml']);
          ...
          var partyFields = false,
              matterFields = false,
              employeeFields = false; //https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/entries
          ...
          if (partyFields && matterFields) {
            _this6.source = 'Party Roles';
          } else if (partyFields) {
            _this6.source = 'Parties';
          } else if (matterFields) {
            _this6.source = 'Matters';
          } else if (employeeFields) {
            _this6.source = 'Employees';
          } else {
            _this6.source = 'General';
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _this7.uploading = true; // Hide the Save button

                _this7.pdfFile = ''; // Clear this in case they upload the same file name
              ...
              case 8:
                ...
                _this7.uploading = false; // Show the Save button

                _context5.next = 26;
                break;

              case 14:
                _this7.record.path = response.data.path;
                _this7.record.fileName = file.name;
                _this7.record.docxFile = response.data.url;

                _this7.checkDocumentSource(_this7.record.docxFile);

                if (!_this7.record.title) _this7.record.title = _this7.record.fileName.split('.')[0];
                if (!_this7.record.description) _this7.record.description = _this7.record.fileName.split('.')[0];
                convertOptions = {
                  destinationPath: 'templates',
                  docxFileName: file.name,
                  source: _this7.record.docxFile,
                  sourceLocation: 'cloud'
                };
                _context5.next = 23;
                return root.documentAssembly.convertToPdf(convertOptions);

              case 23:
                convertResponse = _context5.sent;
                _this7.uploading = false; // Show the Save button

                if (convertResponse.error) {
                  showError('PDF Conversion Error', convertResponse.error);
                } else {
                  _this7.record.pdfFile = _this7.pdfFile = convertResponse.url;

                  if (_this7.editing) {
                    //Update the record but don't close the form
                    _this7.okClicked(false);
                  }
                }
    ...
    replaceDocument: function replaceDocument() {
    ...
    documentUploadError: function documentUploadError(file, message, xhr) {
...
/***/ "./resources/js/pages/extra-screens/ExtraScreenTemplatesForm.vue":
/*!***********************************************************************!*\
  !*** ./resources/js/pages/extra-screens/ExtraScreenTemplatesForm.vue ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ExtraScreenTemplatesForm_vue_vue_type_template_id_2e19b1cf___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ExtraScreenTemplatesForm.vue?vue&type=template&id=2e19b1cf& */ "./resources/js/pages/extra-screens/ExtraScreenTemplatesForm.vue?vue&type=template&id=2e19b1cf&");
/* harmony import */ var _ExtraScreenTemplatesForm_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ExtraScreenTemplatesForm.vue?vue&type=script&lang=js& */ "./resources/js/pages/extra-screens/ExtraScreenTemplatesForm.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _ExtraScreenTemplatesForm_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _ExtraScreenTemplatesForm_vue_vue_type_template_id_2e19b1cf___WEBPACK_IMPORTED_MODULE_0__.render,
  _ExtraScreenTemplatesForm_vue_vue_type_template_id_2e19b1cf___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/pages/extra-screens/ExtraScreenTemplatesForm.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/pages/extra-screens/ExtraScreenTemplatesForm.vue?vue&type=script&lang=js&":
/*!************************************************************************************************!*\
  !*** ./resources/js/pages/extra-screens/ExtraScreenTemplatesForm.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ExtraScreenTemplatesForm_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ExtraScreenTemplatesForm.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/extra-screens/ExtraScreenTemplatesForm.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ExtraScreenTemplatesForm_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/pages/extra-screens/ExtraScreenTemplatesForm.vue?vue&type=template&id=2e19b1cf&":
/*!******************************************************************************************************!*\
  !*** ./resources/js/pages/extra-screens/ExtraScreenTemplatesForm.vue?vue&type=template&id=2e19b1cf& ***!
  \******************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ExtraScreenTemplatesForm_vue_vue_type_template_id_2e19b1cf___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ExtraScreenTemplatesForm_vue_vue_type_template_id_2e19b1cf___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ExtraScreenTemplatesForm_vue_vue_type_template_id_2e19b1cf___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ExtraScreenTemplatesForm.vue?vue&type=template&id=2e19b1cf& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/extra-screens/ExtraScreenTemplatesForm.vue?vue&type=template&id=2e19b1cf&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/extra-screens/ExtraScreenTemplatesForm.vue?vue&type=template&id=2e19b1cf&":
/*!*********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/extra-screens/ExtraScreenTemplatesForm.vue?vue&type=template&id=2e19b1cf& ***!
  \*********************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          _c(
            ...
            [
              _c(
                "div",
                {
                  class: _vm.modal ? "steelblue" : "card-header",
                      ...
                      _c("div", { staticClass: "page-title" }, [
                        _c("h3", [
                          !_vm.editing
                            ...
                            : _c("span", {
                                domProps: {
                                  innerHTML: _vm._s(_vm.pageTitle()),
                                },
                              }),
                        ]),
                        _vm._v(" "),
              ...
              _c(
                ...
                [
                  ...
                  _vm._v(" "),
                  _vm.errors.pdfFile && !_vm.errors.fileName
                    ? _c("div", {
                        staticClass: "mt-3 text-danger",
                        domProps: { innerHTML: _vm._s(_vm.errors.pdfFile[0]) },
                      })
                    : _vm._e(),
                  _vm._v(" "),
                  _vm.errors.docxFile && !_vm.errors.fileName
                    ? _c("div", {
                        staticClass: "mt-3 text-danger",
                        domProps: { innerHTML: _vm._s(_vm.errors.docxFile[0]) },
                      })
                    : _vm._e(),
                  _vm._v(" "),
                  _c(
                        ...
                        [
                          ...
                          _c(
                            "vue-dropzone",
                            {
                              ...
                              staticClass: "boxed",
                              attrs: {
                                id: _vm.id + "-drop-zone-component",
                                options: _vm.dropOptions,
                                useCustomSlot: true,
                              },
                              on: {
                                "vdropzone-error": _vm.documentUploadError,
                                "vdropzone-success": _vm.documentUploaded,
                              },
                            },
                            [
                              _c(
                                ...
                                [
                                  _c("h3", { staticClass: "text-success" }, [
                                    _vm._v(
                                      "Drag and drop a Word Document here"
                                    ),
                                  ]),
                                  _vm._v(" "),
                          ...
                          [
                            ...
                            _c("div", [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "btn btn-danger btn-sm d-inline-block mr-2",
                                  attrs: {
                                    title:
                                      "Generate a test Document using this Template",
                                  },
                                  on: { click: _vm.testMerge },
                                },
                                [
                                  _c("i", {
                                    staticClass: "fa fa-file-word-o mr-2",
                                  }),
                                  _vm._v("Test Document"),
                                ]
                              ),
                              _vm._v(" "),
                              _c(
                                "button",
                                {
                                  ...
                                  attrs: { title: "Replace the Template" },
                                  on: { click: _vm.replaceDocument },
                                },
                                [
                                  _c("i", {
                              ...
                              _c(
                                ...
                                {
                                  staticClass:
                                    "btn btn-primary btn-sm d-inline-block",
                                  attrs: { title: "Download the Template" },
                    ...
                    _c(
                      ...
                      [
                        _c("i", {
                          class: _vm.uploading
                            ? "fa fa-upload"
                            : "fa fa-check-circle" + " fa-lg mr-2",
                        }),
                        _vm._v(" "),
                        _c("span", {
                          domProps: {
                            innerHTML: _vm._s(
                              _vm.uploading ? "Uploading..." : "Save"
                            ),
                          },
                        }),
                      ]
...
var staticRenderFns = [
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", [_c("h4", [_vm._v("Template")])])
  },
  function () {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("span", { attrs: { title: "Delete this Template" } }, [
