(self["webpackChunk"] = self["webpackChunk"] || []).push([["view-pages-settings-SetupCompany-vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/settings/SetupCompany.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/settings/SetupCompany.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    logoDropzone: (vue2_dropzone__WEBPACK_IMPORTED_MODULE_1___default()),
    letterheadDropzone: (vue2_dropzone__WEBPACK_IMPORTED_MODULE_1___default())
  },
  data: function data() {
    return {
      id: 'setup-company',
  ...
  watch: {
    ...
    letterHeadPdfFile: function letterHeadPdfFile(newValue) {
  ...
  methods: {
    smptLoginDetailsChanged: function smptLoginDetailsChanged() {
      axios.post('/employees/saveSmtpDetails', this.employee).then(function (response) {
    ...
    authenticationChanged: function authenticationChanged() {
      var _this = this;

      // Make sure the pop up works when this is unhidden
      if (this.record.smtpAuthentication === 'Yes') {
        setTimeout(function () {
          $('#' + _this.id + ' .popover-icon').popover();
        }, 1000);
      }
    },
    testIncomingServer: function testIncomingServer() {
    ...
    testIncomingMailServer: function testIncomingMailServer(params) {
      root.$snotify.simple('Checking incoming server', 'Please wait...', {
        timeout: 0,
        icon: 'img/cogs.gif'
      });
      axios.post('/mail/testIncomingServer', params).then(function (response) {
        ...
        if (response.data.error) {
          ...
          root.$snotify.simple('Connected to Incoming Email Server', 'Success', {
            timeout: 3000,
            icon: 'img/check.png'
          });
        }
    ...
    testOutgoingServer: function testOutgoingServer() {
      var _this2 = this;

      if (this.record.smtpAuthentication === 'Yes' && (!this.employee.smtpUserName || !this.employee.smtpPassword)) {
        showError('Email Server Login Details Required', '<p>Please insert your User Name and Password and try again.</p>');
      } else {
        axios.get('/employees/get-current').then(function (response) {
          var params = {
            smtpServer: _this2.record.smtpServer,
            smtpPort: _this2.record.smtpPort,
            smtpEncryption: _this2.record.smtpEncryption,
            smtpUserName: _this2.employee.smtpUserName,
            smtpPassword: _this2.employee.smtpPassword,
            email: response.data.email,
            name: response.data.name
          };

          _this2.testOutgoingMailServer(params);
        })["catch"](function (error) {
          showError('Error', error);
        });
      }
    },
    testOutgoingMailServer: function testOutgoingMailServer(params) {
      root.$snotify.simple('Sending test email to ' + params.email, 'Please wait...', {
        timeout: 0,
        icon: 'img/cogs.gif'
      });
      axios.post('/mail/testOutgoingServer', params).then(function (response) {
        root.$snotify.clear();

        if (response.data.error) {
          showError('Email Server Error', response.data.error);
        } else {
          root.$snotify.simple('A test message was sent to ' + params.email + '. Check your inbox to see if you received the email.', 'Sent Email', {
            timeout: 3000,
            icon: 'img/check.png'
          });
        }
    ...
    showGmailHelp: function showGmailHelp() {
      axios.post('/help/get', {
    ...
    letterHeadUploaded: function letterHeadUploaded(file) {
      var _this3 = this;

      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
        var formData, response, convertOptions, convertResponse;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this3.letterHeadPdfFile = ''; // Clear this in case they upload the same file name
              ...
              case 12:
                ...
                _context.next = 16;
                return convertToPdf(convertOptions);

              case 16:
                convertResponse = _context.sent;

                if (convertResponse.error) {
                  showError('PDF Conversion Error', convertResponse.error);
                } else {
                  root.lolSettings.letterheadpdffile = _this3.letterHeadPdfFile = convertResponse.url;

                  _this3.storeLetterHead();
                }
    ...
    storeLetterHead: function storeLetterHead() {
      axios.post('/lolsettings/update', {
        ...
        if (response.data.errors) {
          showError('Error updating letterhead settings', response.data.errors); // } else {
    ...
    downloadLetterHead: function downloadLetterHead() {
    ...
    replaceLetterHead: function replaceLetterHead() {
      this.deleteLetterHead();
      $('#company-letterhead-drop-zone-component').click();
    },
    deleteLetterHead: function deleteLetterHead() {
    ...
    letterHeadUploadError: function letterHeadUploadError(file, message, xhr) {
      showError('Error uploading letterhead', message);
      this.$refs['company-letterhead-drop-zone-component'].removeAllFiles();
    },
    logoUploaded: function logoUploaded(file) {
      var _this4 = this;
      ...
      axios.post('/file/upload', formData, {
        ...
        if (response.data.error) {
          ...
          root.$snotify.simple('The Logo uploaded successfully', 'Success', {
            icon: 'img/check.png'
          });
          axios.post('/lolsettings/update', {
            recordid: root.lolSettings.recordid,
            ...
            if (response.data.errors) {
              ...
              root.lolSettings = _this4.$root.lolSettings = response.data.data[0];
    ...
    replaceLogo: function replaceLogo() {
      this.deleteLogo();
    ...
    logoUploadError: function logoUploadError(file, message, xhr) {
      showError('Error uploading logo', message);
      this.$refs['company-logo-drop-zone-component'].removeAllFiles();
    },
    renderDate: function renderDate(format) {
...
/***/ "./resources/js/pages/settings/SetupCompany.vue":
/*!******************************************************!*\
  !*** ./resources/js/pages/settings/SetupCompany.vue ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _SetupCompany_vue_vue_type_template_id_12438233___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SetupCompany.vue?vue&type=template&id=12438233& */ "./resources/js/pages/settings/SetupCompany.vue?vue&type=template&id=12438233&");
/* harmony import */ var _SetupCompany_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SetupCompany.vue?vue&type=script&lang=js& */ "./resources/js/pages/settings/SetupCompany.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _SetupCompany_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _SetupCompany_vue_vue_type_template_id_12438233___WEBPACK_IMPORTED_MODULE_0__.render,
  _SetupCompany_vue_vue_type_template_id_12438233___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/pages/settings/SetupCompany.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/pages/settings/SetupCompany.vue?vue&type=script&lang=js&":
/*!*******************************************************************************!*\
  !*** ./resources/js/pages/settings/SetupCompany.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_SetupCompany_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./SetupCompany.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/settings/SetupCompany.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_SetupCompany_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/pages/settings/SetupCompany.vue?vue&type=template&id=12438233&":
/*!*************************************************************************************!*\
  !*** ./resources/js/pages/settings/SetupCompany.vue?vue&type=template&id=12438233& ***!
  \*************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_SetupCompany_vue_vue_type_template_id_12438233___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_SetupCompany_vue_vue_type_template_id_12438233___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_SetupCompany_vue_vue_type_template_id_12438233___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./SetupCompany.vue?vue&type=template&id=12438233& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/settings/SetupCompany.vue?vue&type=template&id=12438233&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/settings/SetupCompany.vue?vue&type=template&id=12438233&":
/*!****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/settings/SetupCompany.vue?vue&type=template&id=12438233& ***!
  \****************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function () {
  ...
  return _c(
    "div",
    { staticClass: "card h-100 border-0", attrs: { id: _vm.id } },
    [
      _vm._m(0),
      _vm._v(" "),
      _c(
              ...
              directives: [
                {
                  name: "show",
                  rawName: "v-show",
                  value: _vm.activeTab === "LetterHead",
                  expression: "activeTab === 'LetterHead'",
                },
              ],
                  ...
                  directives: [
                    {
                      name: "show",
                      rawName: "v-show",
                      value: !_vm.letterHeadPdfFile,
                      expression: "!letterHeadPdfFile",
                    },
                  ],
                      ...
                      _c(
                        "letterhead-dropzone",
                        {
                          ...
                          attrs: {
                            ...
                            options: _vm.letterHeadDropOptions,
                            useCustomSlot: true,
                          },
                          on: {
                            "vdropzone-error": _vm.letterHeadUploadError,
                            "vdropzone-success": _vm.letterHeadUploaded,
                          },
                        },
                        [
                          _c(
                            "div",
                            { staticClass: "dropzone-custom-content cp" },
                            [
                              _c(
                                "h1",
                                {
                              ...
                              _vm._v(" "),
                              _c("h3", { staticClass: "text-success mt-5" }, [
                                _vm._v("Drag and drop your letterhead here"),
                              ]),
                              _vm._v(" "),
                              _c("div", { staticClass: "subtitle" }, [
                                _vm._v(
                                  "...or click anywhere in this box to manually select a document"
                                ),
                              ]),
                            ]
                          ),
                      ...
                      [
                        ...
                        _c("div", [
                          _c(
                            ...
                            {
                              staticClass:
                                "btn btn-secondary btn-sm d-inline-block mr-2",
                              attrs: { title: "Replace the Letterhead" },
                              on: { click: _vm.replaceLetterHead },
                            },
                            [
                          ...
                          _c(
                            ...
                            {
                              staticClass:
                                "btn btn-primary btn-sm d-inline-block mr-2",
                              attrs: { title: "Download the Letterhead" },
                              on: { click: _vm.downloadLetterHead },
                            },
                            [
                          ...
                          _c(
                            ...
                            {
                              staticClass:
                                "btn btn-danger btn-sm d-inline-block",
                              attrs: { title: "Delete the Letterhead" },
                              on: { click: _vm.deleteLetterHead },
                            },
                            [
          ...
          _c(
              ...
              directives: [
                {
                  name: "show",
                  rawName: "v-show",
                  value: _vm.activeTab === "Logo",
                  expression: "activeTab === 'Logo'",
                },
              ],
              staticClass: "form-tab-content",
            },
            [
              _c("div", { staticClass: "row" }, [
                _c("div", { staticClass: "col-xxl-6 col-xl-10" }, [
                  _c(
                    "fieldset",
                    { staticClass: "mt-2" },
                    [
                      _c("legend", [_vm._v("Logo")]),
                      _vm._v(" "),
                      _c(
                        "logo-dropzone",
                        {
                          directives: [
                            {
                              name: "show",
                              rawName: "v-show",
                              value: !_vm.record.logo,
                              expression: "!record.logo",
                            },
                          ],
                          ref: "company-logo-drop-zone-component",
                          attrs: {
                            id: "company-logo-drop-zone-component",
                            options: _vm.logoDropOptions,
                            useCustomSlot: true,
                          },
                          on: {
                            "vdropzone-error": _vm.logoUploadError,
                            "vdropzone-success": _vm.logoUploaded,
                          },
                        },
                        [
                          _c(
                            ...
                            [
                              _c("h3", { staticClass: "text-success" }, [
                                _vm._v("Drag and drop a file here"),
                              ]),
                              _vm._v(" "),
                              _c("div", { staticClass: "subtitle" }, [
                                _vm._v(
                                  "...or click here to manually select a file"
                                ),
                              ]),
                            ]
                          ),
                      ...
                      _c("img", {
                        ...
                        attrs: { src: _vm.record.logo, alt: "Company Logo" },
                      }),
                      _vm._v(" "),
                      _c(
                        "div",
                        ...
                        [
                          _c(
                            ...
                            {
                              staticClass:
                                "btn btn-success btn-sm d-inline-block mr-2",
                              attrs: { title: "Change the Company logo" },
                              on: { click: _vm.replaceLogo },
                            },
                            [
                              _c("i", { staticClass: "fa fa-refresh mr-2" }),
                              _vm._v("Replace"),
                          ...
                          _c(
                            "button",
                            {
                              staticClass:
                                "btn btn-danger btn-sm d-inline-block",
                              attrs: { title: "Delete the Company logo" },
              ...
              directives: [
                {
                  name: "show",
                  rawName: "v-show",
                  value: _vm.activeTab === "Email",
                  expression: "activeTab === 'Email'",
                },
              ],
              staticClass: "form-tab-content",
            },
              ...
              _c("div", { staticClass: "row" }, [
                _c("div", { staticClass: "col-xxl-6 mt-xxl-0 mt-xl-3" }, [
                  _c(
                    ...
                    [
                      _c("legend", [_vm._v("Outgoing (SMTP) Server")]),
                      _vm._v(" "),
                      _c(
                        "div",
                        ...
                        [
                          _c("text-input", {
                            attrs: {
                              ...
                              name: "smtpServer",
                              label: "Server",
                              error: _vm.errors.smtpServer,
                            },
                            model: {
                              value: _vm.record.smtpServer,
                              callback: function ($$v) {
                                _vm.$set(_vm.record, "smtpServer", $$v)
                              },
                              expression: "record.smtpServer",
                            },
                          }),
                        ],
                        1
                        ...
                        [
                          _c("text-input", {
                            attrs: {
                              ...
                              name: "smtpPort",
                              label: "Port",
                              error: _vm.errors.smtpPort,
                            },
                            model: {
                              value: _vm.record.smtpPort,
                              callback: function ($$v) {
                                _vm.$set(_vm.record, "smtpPort", $$v)
                              },
                              expression: "record.smtpPort",
                            },
                          }),
                          _vm._v(" "),
                          _c(
                            ...
                            [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "btn btn-danger form-button mb-1",
                                  attrs: {
                                    id: _vm.id + "-gmail-help-button",
                                    type: "button",
                                  },
                                  on: { click: _vm.showGmailHelp },
                                },
                                [_vm._m(4)]
                              ),
                            ]
                        ...
                        [
                          _c("radio-buttons", {
                            attrs: {
                              ...
                              label: "Encryption",
                              error: _vm.errors.smtpEncryption,
                            },
                          }),
                        ],
                        1
                        ...
                        [
                          _c("radio-buttons", {
                            attrs: {
                              ...
                              error: _vm.errors.smtpAuthentication,
                            },
                            on: { change: _vm.authenticationChanged },
                          }),
                        ],
                        1
                      ),
                      _vm._v(" "),
                      _vm.record.smtpAuthentication === "Yes"
                        ? _c(
                            "div",
                            { staticClass: "form-group row" },
                            [
                              _c("text-input", {
                                ...
                                on: { change: _vm.smptLoginDetailsChanged },
                                model: {
                                  value: _vm.employee.smtpUserName,
                                  callback: function ($$v) {
                                    _vm.$set(_vm.employee, "smtpUserName", $$v)
                                  },
                                  expression: "employee.smtpUserName",
                                },
                              }),
                            ],
                            1
                        ...
                        ? _c(
                            ...
                            [
                              _c("text-input", {
                                ...
                                on: { change: _vm.smptLoginDetailsChanged },
                                model: {
                                  value: _vm.employee.smtpPassword,
                                  callback: function ($$v) {
                                    _vm.$set(_vm.employee, "smtpPassword", $$v)
                                  },
                                  expression: "employee.smtpPassword",
                                },
                              }),
                            ],
                            1
                      ...
                      _c("div", { staticClass: "text-right" }, [
                        _c(
                          "button",
                          {
                            ...
                            attrs: {
                              id: _vm.id + "-test-outgoing-email-button",
                              type: "button",
                            },
                            on: { click: _vm.testOutgoingServer },
                          },
                          [_vm._m(5)]
                        ),
                      ]),
                ...
                _c("div", { staticClass: "col-xxl-6 mt-xxl-0 mt-xl-3" }, [
                  _c(
                    ...
                    [
                      _c("legend", [_vm._v("Incoming (IMAP) Server")]),
                      _vm._v(" "),
                      _c(
                        "div",
                        { staticClass: "form-group row" },
                        [
                          _c("text-input", {
                            attrs: {
                              ...
                              name: "incomingServer",
                              label: "Server",
                              error: _vm.errors.incomingServer,
                            },
                            model: {
                              value: _vm.record.incomingServer,
                              callback: function ($$v) {
                                _vm.$set(_vm.record, "incomingServer", $$v)
                              },
                              expression: "record.incomingServer",
                            },
                          }),
                        ],
                        1
                        ...
                        [
                          _c("text-input", {
                            attrs: {
                              ...
                              name: "incomingPort",
                              label: "Port",
                              error: _vm.errors.incomingPort,
                            },
                            model: {
                              value: _vm.record.incomingPort,
                              callback: function ($$v) {
                                _vm.$set(_vm.record, "incomingPort", $$v)
                              },
                              expression: "record.incomingPort",
                            },
                          }),
                        ],
                        1
                        ...
                        [
                          _c("radio-buttons", {
                            attrs: {
                              ...
                              label: "Encryption",
                              error: _vm.errors.incomingEncryption,
                            },
                          }),
                        ],
                        1
                      ...
                      _c("div", { staticClass: "text-right" }, [
                        _c(
                          "button",
                          {
                            ...
                            staticClass: "btn btn-danger form-button mt-1",
                            attrs: {
                              id: _vm.id + "-test-incoming-email-button",
                              type: "button",
                            },
                            on: { click: _vm.testIncomingServer },
                          },
                          [_vm._m(6)]
                        ),
                      ]),
...
var staticRenderFns = [
  ...
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", [_c("h4", [_vm._v("Letterhead")])])
  },
  function () {
    var _vm = this
    var _h = _vm.$createElement
    ...
    return _c("div", { staticClass: "col-md-12" }, [
      _c("iframe", {
        ...
        attrs: { id: "setup-company-letterhead-pdf-iframe" },
      }),
    ])
  },
  function () {
    ...
    return _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-md-12" }, [
        _c("h4", [_vm._v("Reasons to your an Email System like Mailgun")]),
        _vm._v(" "),
        _c("p", [_vm._v("Blocked by your hosting provider while sending")]),
        _vm._v(" "),
        _c("p", [
          _vm._v(
        ...
        _vm._v(" "),
        _c("p", [
          _vm._v("Went to SPAM or another automatically filtered folder"),
        ]),
        _vm._v(" "),
        _c("p", [_vm._v("Went to GMail tab like “Promotions")]),
        _vm._v(" "),
        _c("p", [_vm._v("Technical errors in the program")]),
        _vm._v(" "),
        _c(
          "a",
          {
            attrs: {
              href: "https://laraveldaily.com/how-to-send-email-from-laravel-and-why-we-need-3rd-party-providers-for-it/",
            },
          },
          [_vm._v("Source")]
        ),
  ...
  function () {
    ...
    return _c(
      "span",
      { attrs: { title: "Help on setting up access to a Gmail account" } },
      [
        _c("i", { staticClass: "fa fa-question-circle fa-lg mr-2" }),
        _vm._v(
          "\r\n                                    Gmail Help\r\n                                "
        ),
      ]
  ...
  function () {
    ...
    return _c(
      "span",
      {
        attrs: { title: "Check if you can login to the Outgoing Email Server" },
      },
      [
  ...
  function () {
    ...
    return _c(
      "span",
      {
        attrs: { title: "Check if you can login to the Incoming Email Server" },
      },
      [
        _c("i", { staticClass: "fa fa-cog fa-lg mr-2" }),
        _vm._v("Test Connection"),
