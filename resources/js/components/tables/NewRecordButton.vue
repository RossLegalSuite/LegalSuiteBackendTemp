...
export default {
    ...
    methods: {
        ...
        newRecordButtonClicked() {
            ...
            } else if ( typeof this.$parent.newRecordButtonClicked === 'function' ) {

                this.$parent.newRecordButtonClicked( this.$parent );


            } else if ( typeof this.$parent.$parent.newRecordButtonClicked === 'function' ) {

                this.$parent.$parent.newRecordButtonClicked( this.$parent );
