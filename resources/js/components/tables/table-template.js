    ...
    methods: {
        ...
        loadDataTable( callback = null ) {
            ...
            if ( this.tagTableFlag  ) {
                ...
                // Some tags (like SelectMatters) are just in memory
                if ( this.saveTagsFlag ) {
        ...
        createDataTable( initialOrder, callback = null ) {
            ...
            let thisTable = $('#' + this.tableId).DataTable({
                ...
                rowId: this.tableOptions.rowId ? this.tableOptions.rowId : 'id',
        ...
        setUserFilters() {
            ...
            tableFilters.forEach( ( tableFilter ) => {
                ...
                if ( !tableFilter.calculatedColumn ) {
                    ...
                    } else if ( tableFilter.filterType === 'String' && tableFilter.method ) {
        ...
        toggleTaggedRows( component ) {
            ...
            if ( component.selectedRows.length ) {
                ...
                clearTagged( component, this.saveTagsFlag );
                ...
                if (this.saveTagsFlag ) {
                    ...
                    component.selectedRows = this.table.rows({ selected: true }).ids().toArray();
                }
            }
        ...
        jumpToRow(rowId, tablePosition) {
            ...
            // console.log("this.table.scroller",this.table.scroller);
        ...
        async createReportTemplateData() {
            ...
            templateData.report = {
                ...
                date: moment().format('D-MMM-Y HH:mm:ss'),
            };
