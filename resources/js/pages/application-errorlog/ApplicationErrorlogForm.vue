            ...
            <div :id="id + '-form-header'" :class="modal ? 'red-bg' : 'card-header'">
                ...
                <div :class="modal ? 'modal-header' : 'd-flex justify-content-between'">
                    ...
                    <div class="page-title">
                        <h3>
                            <span v-if="!editing && !savedFlag">Application Error Log will be Added</span>
                            <span v-else>Application Error</span>
                        </h3>
            ...
            <div class="modal-footer justify-content-between">
                <div>
                    ...
                    <button v-show="editing" class="btn btn-primary form-button mr-3" type="button" @click="deleteClicked">
                        <span title="Delete this Application Error Log"><i class="fa fa-trash fa-lg mr-2"></i>Delete</span>
                    </button>
...
export default {
    ...
    props: {
        resource: {type: String, default: 'ApplicationErrorLog' },
        uniqueId: String,
    },    
    ...
    methods: {
        ...
        editRecord(id) {
            ...
            axios.post('/application_errors/get',{id: id})
        ...
        okClicked( closeFlag = true ) {
            ...
            root.$snotify.simple('Please wait...', 'Saving Application Error Log', { timeout: 10000, icon: 'img/cogs.gif' });
                ...
                if (response.data.errors) {
                    ...
                    if (!this.editing && !this.savedFlag) {
                        ...
                        this.highlightRow(response.data.data[0].id, {
                            where: "clients.email,<,'" + response.data.data[0].email + "'",
                            orderBy: 'email'
                        });
