...
export default {
    ...
    methods: {
        ...
        clientSelected(selectedRecord) {
            ...
            this.record.client_id = selectedRecord.id;
        ...
        editRecord(id) {
            ...
            this.selectClient.setReadOnly = true;
            ...
            .then(response => {
                ...
                this.selectClient.record = {
                    firmcode: this.record.clientcode + ' - ' + this.record.clientname
                };
        ...
        initNewRecord() {
            ...
            this.selectClient.setReadOnly = false;
            ...
            this.record = {
                client_id: null,
                developer_id: this.$parent.record.id,
