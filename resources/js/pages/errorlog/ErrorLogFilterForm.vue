            ...
            <div class="card-body form-tab-body overflow-auto p-3" style="height: 55vh;">
                ...
                <div v-show="activeTab === 'Custom'" class="form-tab-content">
                    ...
                    <custom-filter
                        ...
                        <p>api_errors.message LIKE '%sql%'</p>
                        <p>(api_errors.message LIKE '%state%' OR api_errors.message LIKE '%sql%')</p>"
                        :popOverContainer="'#' + id"
                    />
                </div>
...
export default {
    ...
    data() {
        return {
            table: null,
            dateFilterColumnName: 'api_errors.created_at',

            descriptionSelected: '',
            descriptionFilterColumnName: 'api_errors.message',
