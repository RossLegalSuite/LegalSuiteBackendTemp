...
<div id="guest-login-form" class="card h-100 border-0">
    ...
    <form-buttons :editing="false" saveText="Login" saveTitle="Login to the program" record="User" @ok-clicked="okClicked" @cancel-clicked="hide" />
...
export default {
    ...
    methods: {
        ...
        okClicked() {
            ...
            root.$snotify.simple('Logging in ' + this.record.login, 'LegalSuite Backend', { timeout: 0, icon: 'img/cogs.gif' });
            ...
            .then(response => {
                ...
                if (response.data.errors) { 
                    ...
                    if ( response.data.errors.login || response.data.errors.password ) {
