...
<head>
    ...
    <meta name="description" content="API management tool">
    <meta name="author" content="LegalSuite Software">

    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>LegalSuite Backend @yield('title')</title>
...
<body>
    ...
    <div id="app" class="stitched-border">
        ...
        <div class="d-flex filofax-footer">
            <div class="flex-fill">Version (1.0.0)</div>
            <div class="flex-fill text-right">{{session('employeeName')}}</div>
        </div>
